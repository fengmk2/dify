...
export function AgentSkillDetailDialog({
  ...
  return (
    <DialogContent
      ...
      className="flex h-[min(720px,calc(100dvh-2rem))] max-h-none w-[min(960px,calc(100vw-2rem))] flex-col overflow-hidden rounded-2xl p-0"
    >
      ...
      <div className="shrink-0 border-b-[0.5px] border-components-panel-border-subtle pt-6 pr-14 pb-3 pl-6">
        <DialogTitle className="title-xl-semi-bold text-text-primary">{skillName}</DialogTitle>
      ...
      <div className="flex min-h-0 flex-1 items-start">
        <ScrollArea
          ...
          slotClassNames={{
            viewport:
              'overscroll-contain outline-none focus-visible:outline-none mask-linear-[to_bottom,transparent_0,black_min(40px,var(--scroll-area-overflow-y-start)),black_calc(100%_-_min(40px,var(--scroll-area-overflow-y-end,40px))),transparent_100%] mask-no-repeat',
