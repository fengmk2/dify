...
function releaseSourceLabel(
  ...
  if (release?.source === ReleaseSource.RELEASE_SOURCE_UPLOAD) return t('versions.manualDslOption')
  return '—'
}
...
export function ReleaseMetaTooltip({
  ...
  const rows = [
    { label: t('card.tooltip.releaseName'), value: release.displayName },
    {
      ...
      value: deployed ? t('card.tooltip.deployed') : t('card.tooltip.notDeployedShort'),
    },
