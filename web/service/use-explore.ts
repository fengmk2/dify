...
export const useExploreAppList = (options: { enabled?: boolean } = {}) => {
  ...
  return useQuery<ExploreAppListData>({
    queryKey: [
      ...consoleQuery.explore.apps.queryKey({ input: exploreAppsInput }),
      exploreAppsLanguage,
    ],
    queryFn: async () => {
...
export const useLearnDifyAppList = () => {
  ...
  return useQuery({
    queryKey: [
      ...consoleQuery.explore.learnDifyApps.queryKey({ input: learnDifyAppsInput }),
...
export const useGetInstalledAppParams = (appId: string | null) => {
  ...
  return useQuery({
    queryKey: [
      ...consoleQuery.explore.installedAppParameters.queryKey({ input: installedAppParamsInput }),
      installedAppId,
    ],
    queryFn: () => {
...
export const useGetInstalledAppMeta = (appId: string | null) => {
  ...
  return useQuery({
    queryKey: [
      ...consoleQuery.explore.installedAppMeta.queryKey({ input: installedAppMetaInput }),
      installedAppId,
    ],
    queryFn: () => {
