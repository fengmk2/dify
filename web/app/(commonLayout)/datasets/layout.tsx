...
export default function DatasetsLayout({ children }: { children: React.ReactNode }) {
  ...
  const isLoadingCurrentWorkspace = useAppContextSelector(
    (state) => state.isLoadingCurrentWorkspace,
  )
  const isLoadingWorkspacePermissionKeys = useAppContextSelector(
