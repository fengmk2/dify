...
describe('IndexingModeSection', () => {
  ...
  describe('Embedding Model', () => {
    ...
    it('should call onEmbeddingModelChange when model selected', () => {
      ...
      render(
        <IndexingModeSection {...defaultProps} onEmbeddingModelChange={onEmbeddingModelChange} />,
      )
      fireEvent.click(screen.getByText('Select Model'))
      expect(onEmbeddingModelChange).toHaveBeenCalledWith({
        provider: 'openai',
  ...
  describe('Retrieval Config', () => {
    ...
    it('should call onRetrievalConfigChange from qualified config', () => {
      ...
      render(
        <IndexingModeSection {...defaultProps} onRetrievalConfigChange={onRetrievalConfigChange} />,
      )
    ...
    it('should call onQAConfirmDialogClose when cancel clicked', () => {
      ...
      render(
        <IndexingModeSection
          ...
          onQAConfirmDialogClose={onClose}
        />,
      )
    ...
    it('should call onQAConfirmDialogConfirm when confirm clicked', () => {
      ...
      render(
        <IndexingModeSection
          {...defaultProps}
          isQAConfirmDialogOpen
          onQAConfirmDialogConfirm={onConfirm}
        />,
      )
  ...
  describe('Dataset Settings Link', () => {
    it('should show settings link when economical and hasSetIndexType', () => {
      ...
      expect(screen.getByText(`${ns}.stepTwo.datasetSettingLink`).closest('a'))!.toHaveAttribute(
        'href',
        '/datasets/ds-123/settings',
      )
    })
