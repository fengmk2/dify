    ...
    return (
      <div
        ...
        className={cn(
          ...
          current &&
            "after:pointer-events-none after:absolute after:inset-0 after:rounded-xl after:ring-[1.5px] after:ring-components-option-card-option-selected-border after:content-[''] after:ring-inset",
        )}
      >
