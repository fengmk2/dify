 ...
 *-----------------------------------------------------------*/ ;(function () {
  ...
  ;(function (W) {
    ...
    class A {
      ...
      _canUseEval(a) {
        return (
          this._cachedCanUseEval === null && (this._cachedCanUseEval = x(a)), this._cachedCanUseEval
        )
      }
      load(a, m, e, h) {
        if (/^node\|/.test(m)) {
...
//# sourceURL=${m}`),
    ...
    class d {
      ...
      _initNodeRequire(a, m) {
        ...
        r.prototype._compile = function (o, u) {
          ...
          return (
            h._handleCachedData(v, S, N, !P.cachedData, m), h._verifyCachedData(v, S, N, E, m), M
          )
        }
      }
      load(a, m, e, h) {
  ...
  ;(function (W) {
    ...
    class i {
      ...
      onDependencyError(c) {
        return (
          (this._isComplete = !0), (this.error = c), this._errorback ? (this._errorback(c), !0) : !1
        )
      }
      isComplete() {
...
`),
      ...
      _onModuleComplete(c) {
        ...
        const h = (o) =>
          (this._inverseDependencies2[o] || []).map((u) => this._moduleIdProvider.getStrModuleId(u))
      ...
      class z {
        ...
        findLastMaxBy(q) {
          let B,
            G = !0
          return (
            this.iterate(($) => ((G || y.isGreaterThan(q($, B))) && ((G = !1), (B = $)), !0)), B
          )
        }
      }
          ...
          return (
            (this._event ??= (R, D, T) => {
              if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                ...
                return (
                  (this._options?.onListenerError || i.onUnexpectedError)(G), A.Disposable.None
                )
              }
    ...
    X(J[13], Z([0, 1, 3, 5, 2, 15]), function (W, n, i, x, A, d) {
      ...
      class p {
        ...
        subtractFrom(a) {
          ...
          return (
            r < a.endLineNumberExclusive && h.push(new f(r, a.endLineNumberExclusive)), new p(h)
          )
        }
        toString() {
    ...
    X(J[31], Z([0, 1, 19, 20]), function (W, n, i, x) {
      ...
      function p(a, m, e, h, r) {
        if (((m = d(m)), r || (r = i.Iterable.first(f)), e.length > r.maxLen)) {
          let L = a - r.maxLen / 2
          return (
            L < 0 ? (L = 0) : (h += L), (e = e.substring(L, a + r.maxLen / 2)), p(a, m, e, h, r)
          )
        }
        const s = Date.now(),
          o = a - 1 - h
    ...
    X(J[33], Z([0, 1, 15, 5, 4, 2, 16]), function (W, n, i, x, A, d, f) {
      ...
      class p {
        ...
        getBoundaryScore(r) {
          ...
          let u = 0
          return (
            s !== o && ((u += 10), s === 0 && o === 1 && (u += 1)), (u += m(s)), (u += m(o)), u
          )
        }
      ...
      function (W, n, i, x, A, d, f, p, c, a, m, e, h, r, s, o) {
        ...
        function S(P, E, v, l = !1) {
          ...
          for (const g of (0, i.groupAdjacentBy)(
            P.map((w) => L(w, E, v)),
            (w, M) =>
              w.original.overlapOrTouch(M.original) || w.modified.overlapOrTouch(M.modified),
          )) {
            const w = g[0],
              M = g[g.length - 1]
            b.push(
...
` ||
    ...
    X(J[14], Z([0, 1, 37, 11]), function (W, n, i, x) {
      ...
      function P(b, g) {
        ...
        return (
          R && ((M += '?'), (M += w(R, !1, !1))), D && ((M += '#'), (M += g ? D : S(D, !1, !1))), M
        )
      }
      function E(b) {
        try {
