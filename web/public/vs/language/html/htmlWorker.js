          ...
          function (e, r, u) {
            ...
            ;((s.prototype = new c()),
              ...
              (s.prototype.read = function () {
                ...
                return (
                  this._until_after && (l += this._input.readUntilAfter(this._until_pattern)), l
                )
              }),
          ...
          static revive(_) {
            if (_) {
              if (_ instanceof p) return _
              {
                let C = new A(_)
                return (
                  (C._formatted = _.external), (C._fsPath = _._sep === m ? _.fsPath : null), C
                )
              }
            }
            return _
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
    ...
    var Ne = class {
      ...
      _getTextDocument(n) {
        ...
        for (let a of o)
          if (a.uri.toString() === n) return ve.create(n, this._languageId, a.version, a.getValue())
        return null
      }
    }
    function Di(t, n) {
