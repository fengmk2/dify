...
| pinned  | boolean                                                                                                                  |                                                                          | No       |
| sort_by | string, <br>**Available values:** "-created_at", "-updated_at", "created_at", "updated_at", <br>**Default:** -updated_at | _Enum:_ `"-created_at"`, `"-updated_at"`, `"created_at"`, `"updated_at"` | No       |
...
| Name          | Type                                                      | Description                                          | Required |
| ------------- | --------------------------------------------------------- | ---------------------------------------------------- | -------- |
| response_mode | string, <br>**Available values:** "blocking", "streaming" | Response mode<br>_Enum:_ `"blocking"`, `"streaming"` | Yes      |
