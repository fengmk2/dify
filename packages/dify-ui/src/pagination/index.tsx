...
export function PaginationNavigation({ render, className, ...props }: PaginationNavigationProps) {
  const defaultProps: useRender.ElementProps<'div'> = {
    className: cn(
      'flex shrink-0 items-center justify-self-start gap-0.5 rounded-[10px] bg-background-section-burn p-0.5',
      className,
    ),
  }
...
export function PaginationPageList({ render, className, ...props }: PaginationPageListProps) {
  ...
  const defaultProps: useRender.ElementProps<'ol'> = {
    className: cn(
      'col-start-2 flex min-w-0 list-none items-center justify-self-center gap-0.5',
      className,
    ),
...
export function PaginationPageSize<Value extends number = number>({
  ...
  return (
    <div
      className={cn(
        'group/page-size col-start-3 flex shrink-0 items-center justify-end justify-self-end gap-2',
        className,
      )}
    >
